 ...
 *
 * <p>
 * The node has the parameters of connection, the position in the input text,
...
public interface LatticeNode {
     ...
     *
     * @param leftId
     *            the left-ID of connection
     * @param rightId
     *            the right-ID of connection
     * @param cost
     *            the word occurrence cost
     */
    ...
    /**
     * Returns the index to after the last position of the node in the input text.
     * The last position of the nodes is {@code getEnd() - 1}.
     *
     * @return the index to after the last position of the node in the input text.
     */
    public int getEnd();
     ...
     *
     * @param begin
     *            the index to the first position of the node in the input text.
     * @param end
     *            the index to after the last position of the node in the input
     *            text.
     */
    ...
    /**
     * Returns the cost of the path from the beginning of sentence to this node.
     *
