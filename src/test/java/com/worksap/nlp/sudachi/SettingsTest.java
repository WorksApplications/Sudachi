...
public class SettingsTest {
    ...
    public void parseSettings() {
        assertNotNull(Settings.parse("{}", PathAnchor.none()));
    }
    ...
    public void getString() {
        Settings settings = Settings.parse("{\"foo\":\"baa\"}", PathAnchor.none());
    ...
    public void getStringWithError() {
        Settings settings = Settings.parse("{\"foo\":123}", PathAnchor.none());
    ...
    public void getStringWithDefaultValue() {
        ...
        settings = Settings.parse("{\"foo\":123}", PathAnchor.none());
        assertEquals("nyaa", settings.getString("foo", "nyaa"));
    }

    @Test
    public void getStringList() {
        Settings settings = Settings.parse("{\"foo\":[\"baa\",\"bazz\"]}", PathAnchor.none());
    ...
    public void getStringListWithError() {
        Settings settings = Settings.parse("{\"baa\":123}", PathAnchor.none());
    ...
    public void getIntListList() {
        Settings settings = Settings.parse("{\"foo\":[[123],[456, 789]]}", PathAnchor.none());
    ...
    public void getPath() {
        ...
        settings = Settings.parse("{\"foo\":\"baa\"}", PathAnchor.filesystem(Paths.get("maa")));
    ...
    public void getPathList() {
        ...
        settings = Settings.parse("{\"foo\":[\"baa\",\"bazz\"]}", PathAnchor.filesystem(Paths.get("maa")));
        assertThat(settings.getPathList("foo"),
    ...
    @Test
    public void merge() {
        Settings settings = Settings.parse("{\"baa\":\"bazz\",\"list\":[1,2]}", PathAnchor.none());
        Settings settings2 = Settings.parse("{\"baa\":\"boo\",\"list\":[5],\"list2\":[0]}",
                PathAnchor.filesystem(Paths.get("path")));
